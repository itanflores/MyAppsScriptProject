 ...
 */
const CONFIG = {
  rvToolsFileId: 'TU_ID_DEL_ARCHIVO_RVTOOLS', // Reemplázalo con el ID del archivo RVTools.
  inventoryFileId: 'TU_ID_DEL_INVENTARIO',   // Reemplázalo con el ID del archivo de inventario.
};
